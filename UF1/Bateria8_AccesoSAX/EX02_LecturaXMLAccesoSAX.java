...
// EJERCICIO 2. Prueba a leer con el programa del ejercicio anterior el documento “personas.xml” (se trata del xml que generamos en la clase anterior)
...
public class EX02_LecturaXMLAccesoSAX {
	public static void main (String [] args) throws FileNotFoundException, IOException, SAXException {
		...
		InputSource fileXML = new InputSource ("Emple.xml");
