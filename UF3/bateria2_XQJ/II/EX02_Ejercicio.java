 ...
 * programa que reciba un n�mero de zona por par�metro y genere un documento 
 ...
 * <denominaci�n>, <precio>, <nombre_zona>, <director> y <stock>. Donde el stock
 * se calcula restando el stock actual y el stock m�nimo.*/
...
public class EX02_Ejercicio {
	public static void main(String[] args) throws XQException, IOException{
		...
		try{
			...
			conn.close();
			writer.close();
			System.out.print("Se ha creado el fichero "+fileName+ " con �xito.");
